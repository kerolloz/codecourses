                    ...
                    <div class="card-body">
                        ...
                        <form class="signin-form" method="post" action="<?= $_SERVER['PHP_SELF']; ?>">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label">Remember me.<a href="#" class="need-help"> Need
                                        Help?</a>
                                </label>
                            </div>
                        </form>
                    ...
                    <div class="card-body">
                        ...
                        <form class="signin-form" method="post" action="<?= $_SERVER['PHP_SELF']; ?>">
                            ...
                            if (count($reg_errors) > 0) {
                                ...
                                echo '<span id="registration_errors" style="height: 100px" > ' . $errors . ' </span>';
                            }
                            ?>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="fnameInput" placeholder="First Name"
                                               name="fname" required <?php if ($reg_errors) {
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="lnameInput" placeholder="Last Name"
                                               name="lname" required <?php if ($reg_errors) {
                            ...
                            <div class="form-group">
                                <input type="email" class="form-control" id="emailInput" placeholder="Email"
                                       name="email" required <?php if ($reg_errors) {
                                    echo 'value="' . htmlentities($email) . '"';
                                } ?>
                                >
                            </div>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="usernameInput" placeholder="Username"
                                       name="username" required <?php if ($reg_errors) {
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" id="passwordConInput"
                                       placeholder="Password Confirmation" name="password2" required>
                            </div>
