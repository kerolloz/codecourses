    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="videoContainer">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/lM_sX-7i58g" style="border:0;"
...
<div class="container">
    <div class="row">
        <div class="col-4">
            <div class="box">
                <div class="icon">
                    <img src="../assets/images/codeCourses_opt_opt.png" alt="logo">
                </div>
                <br>
                <label><a href="../problemset/index.php">Problem Set</a></label>
                <hr>
                <p>A large, variant and good staff of problems
        ...
        <div class="col-4">
            <div class="box">
                ...
                <p>With us, now you can know how to start
                    you journey with problem solving. If you
