                        ...
                        <div class="custom-tab">
                            <nav>
                                <div class="nav nav-justified nav-tabs" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-selected nav-link active show" id="custom-nav-home-tab"
                                       data-toggle="tab" href="#custom-nav-problems" role="tab"
                                       aria-controls="custom-nav-home" aria-selected="false">Problems</a>
                                    <a class="nav-item nav-selected nav-link" id="custom-nav-contact-tab"
                                       data-toggle="tab" href="#custom-nav-contests" role="tab"
                                       aria-controls="custom-nav-contact" aria-selected="true">Contests</a>
                                </div>
                            </nav>
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade active show" id="custom-nav-problems" role="tabpanel"
                                         aria-labelledby="custom-nav-contact-tab">
                                        <?php require 'html_includes/problems-table.php'; ?>
                                    </div>

                                    <div class="tab-pane fade" id="custom-nav-contests" role="tabpanel"
