...
function SubmitDownloadPDF() {
    ...
    const pdf_problem_link = $("#pdf_problem_link").val();
...
function SubmitParseTestCases() {
    ...
    const submission_link = $("#submission_link").val();
...
$(document).ready(function () {
    $(".delete-contest-button").click(function () {
        const choice = confirm("By deleting this contest you will delete:\n" +
    ...
    $("#delete-submissions-button").click(function () {
        $.post(
    ...
    $(".delete-problem-button").click(function () {
        const choice = confirm("By deleting this problem you will delete:\n " +
