...
<div class="page-wrapper">
    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <div class="modal fade" id="cfPDFDownloader" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                 aria-hidden="true">
                        ...
                        <form id="noRefreshForm" method="post">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="url" name="pdf_problem_link" class="form-control" id="pdf_problem_link"
                                           required>
                                </div>
                                <div class="progress mb-2" id="cfPDFDownloaderProgressBarr" style="visibility: hidden;">
                                    <div class="progress-bar bg-success progress-bar-striped progress-bar-animated"
                                         ...
                                         aria-valuemax="100">Please Wait While Downloading Your
                                        PDF
                                    </div>
                                </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                        onclick="document.getElementById('cfPDFDownloaderProgressBarr').style.visibility = 'hidden';">
                                    Close
                                </button>
                                <button class="submit btn btn-primary" type="button" value="Submit" name="download_pdf"
                                        onclick="SubmitDownloadPDF();">Download PDF
                                </button>
            ...
            <!-- modal CF-PARSER -->
            <div class="modal fade" id="cfSubmissionParserModal" tabindex="-1" role="dialog"
                        ...
                        <form method="post" action="">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" name="submission_link" class="form-control" id="submission_link"
                                           required>
                                </div>
                                <div class="progress mb-2" id="cfSubmissionParserProgressBarr"
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                        onclick="document.getElementById('cfSubmissionParserProgressBarr').style.visibility = 'hidden';">
                                    Close
                                </button>
                                <button type="button" name="download_test_cases" class="btn btn-primary"
                                        onclick="SubmitParseTestCases();">Parse Test Cases
                                </button>
                            </div>
                        </form>
            ...
            <!-- modal TESTCASE -->
            <div class="modal fade" id="testcaseModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                 aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="problem_name"
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">Problem
                                                    Level</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9 input-group">
                                                <input type="number" id="text-input" name="time_limit"
                                                       class="form-control" placeholder="Time Limit" value="1" min="1"
                                                       max="30" required>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9 input-group">
                                                <input type="number" id="text-input" name="memory_limit"
                                                       class="form-control" placeholder="Memory Limit" value="5" min="5"
                                                       max="500" required>
                                                <div class="input-group-append">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9 input-group">
                                                ...
                                                <button type="button" class="btn btn-warning" data-toggle="modal"
                                                        data-target="#cfPDFDownloader" data-whatever="@mdo">
                                                    CF PDF Downloader&nbsp;
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9 input-group">
                                                ...
                                                <button type="button" class="btn btn-success" data-toggle="modal"
                                                        data-target="#cfSubmissionParserModal" data-whatever="@mdo">
                                                ...
                                                <button type="button" class="btn btn-info" data-toggle="modal"
                                                        data-target="#testcaseModal" data-whatever="@mdo">
                                                ...
                                                if (isset($download_test_cases_submission_folder_name)):
                                                    ...
                                                    ?>
                                                    <input type="text" name="download_test_cases_submission_folder_name"
                                                           value="<?= $download_test_cases_submission_folder_name ?>"
                                                           hidden>
                                                <?php
