    ...
    <div class="row">
        <div class="col-8">
            ...
            <div class="videooContainer">
                <iframe width="750" height="500" src="https://www.youtube.com/embed/RRouhxZJKak" frameborder="0"
                    ...
                    <div class="card-header" id="headingOne1">
                        <h5 class="mb-0">
                            <button class="btn btn-link" type="button" data-toggle="collapse"
                                    data-target="#collapseOne1" aria-expanded="true" aria-controls="collapseOne1" style>
                                BEGINNERS
                            </button>
                        </h5>
                    </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="card-body">
                            ...
                            <br><br>
                            <a href="https://www.tutorialspoint.com/cplusplus/cpp_data_types.htm" target="_blank">Article
                                2</a>
                            <br><br>
